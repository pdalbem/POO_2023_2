public class Main {
    public static void main(String[] args) {
        ...
        Matricula m1 = new Matricula(a1, d1, 9, 70, "2023.1");
        Matricula m2 = new Matricula(a2, d1, 10, 90,"2023.1");
        Matricula m3 = new Matricula(a2, d2, 8, 100, "2023.1");
        Matricula m4 = new Matricula(a3,d2, 9, 100, "2023.1");
        Matricula m5 = new Matricula(a3, d3, 10,90, "2023.1");
